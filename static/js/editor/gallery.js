...
export function showGalleryEmptyState() {
  ...
  if (empty) {
    ...
    if (state.galleryMode === 'pdf') {
      if (msg) msg.textContent = 'Nenhuma imagem pré-carregadas na galeria. clique no botão abaixo para fazer um novo Upload de PDF e extrair os seus elementos de imagens.';
